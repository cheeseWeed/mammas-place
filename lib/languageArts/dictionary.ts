...
export const DICTIONARY_ITEMS: DictionaryItem[] = [
  ...
  // -- additional etymology — medium-tier (more familiar, lighter difficulty) --
  {
    id: 'etym-m-1',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "chocolate" come from?',
    choices: ['a Native American language (Nahuatl)', 'French', 'Italian', 'German'],
    answer: 'a Native American language (Nahuatl)',
    rule: '"Chocolate" comes from "xocolatl" — a word from the Aztec people of Mexico. The Spanish brought the word into Europe.',
  },
  {
    id: 'etym-m-2',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "tomato" come from?',
    choices: ['a Native American language (Nahuatl)', 'Italian', 'French', 'Spanish'],
    answer: 'a Native American language (Nahuatl)',
    rule: '"Tomato" comes from "tomatl" — another Aztec word from Mexico. (Italian uses "pomodoro" instead.)',
  },
  {
    id: 'etym-m-3',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "spaghetti" come from?',
    choices: ['Italian', 'French', 'Spanish', 'German'],
    answer: 'Italian',
    rule: '"Spaghetti" is Italian — it means "little strings" (spago = string).',
  },
  {
    id: 'etym-m-4',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "yogurt" come from?',
    choices: ['Greek', 'Turkish', 'Italian', 'French'],
    answer: 'Turkish',
    rule: '"Yogurt" comes from the Turkish word "yoğurt" — it traveled into English in the 1600s.',
  },
  {
    id: 'etym-m-5',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "moose" come from?',
    choices: ['French', 'a Native American language (Algonquian)', 'German', 'Spanish'],
    answer: 'a Native American language (Algonquian)',
    rule: 'English borrowed "moose" from Algonquian peoples in northeastern North America — it means "twig-eater".',
  },
  {
    id: 'etym-m-6',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "tornado" come from?',
    choices: ['Spanish', 'French', 'Italian', 'English'],
    answer: 'Spanish',
    rule: '"Tornado" comes from a Spanish word for thunderstorm — Spanish sailors brought it into English in the 1500s.',
  },
  {
    id: 'etym-m-7',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "robot" come from?',
    choices: ['Czech', 'French', 'Russian', 'English'],
    answer: 'Czech',
    rule: '"Robot" comes from a Czech word "robota" (hard work). It first appeared in a 1920 Czech play and spread worldwide.',
  },
  {
    id: 'etym-m-8',
    skill: 'etymology', tier: 'medium',
    prompt: 'Which language did the word "school" come from?',
    choices: ['Greek', 'French', 'Latin', 'German'],
    answer: 'Greek',
    rule: '"School" comes from the Greek word "schole" — which originally meant "free time" for learning and thinking!',
  },

  // -- additional pronunciation — more 3-syllable practice (medium) --
  {
    id: 'pron-m-7',
    skill: 'pronunciation', tier: 'medium',
    prompt: 'Which word is pronounced "kal-EN-der"?',
    choices: ['calendar', 'colander', 'cellar', 'cylinder'],
    answer: 'calendar',
    rule: 'kal-EN-der = calendar. Three syllables, stress on the middle.',
  },
  {
    id: 'pron-m-8',
    skill: 'pronunciation', tier: 'medium',
    prompt: 'Which word is pronounced "to-MAY-toh"?',
    choices: ['tomato', 'tornado', 'tomorrow', 'tabasco'],
    answer: 'tomato',
    rule: 'to-MAY-toh = tomato. (Some say "to-MAH-toh" too — both are correct.)',
  },
  {
    id: 'pron-m-9',
    skill: 'pronunciation', tier: 'medium',
    prompt: 'Which word is pronounced "yes-ter-day"?',
    choices: ['yesterday', 'yardstick', 'yodeled', 'yelping'],
    answer: 'yesterday',
    rule: 'yes-ter-day = yesterday. Three syllables, stress on the first.',
  },
  {
    id: 'pron-m-10',
    skill: 'pronunciation', tier: 'medium',
    prompt: 'Which word is pronounced "skel-uh-tun"?',
    choices: ['skeleton', 'skater', 'sculpture', 'speculate'],
    answer: 'skeleton',
    rule: 'skel-uh-tun = skeleton. The middle "uh" is unstressed; the "on" sounds like "un".',
  },

  // -- additional pronunciation — hard (silent letters, tricky spellings) --
  {
    id: 'pron-h-7',
    skill: 'pronunciation', tier: 'hard',
    prompt: 'Which word is pronounced "NUM" (a finger you can\'t feel)?',
    choices: ['numb', 'numbed', 'number', 'nimble'],
    answer: 'numb',
    rule: '"Numb" is pronounced "num" — the B at the end is SILENT. Same for "thumb", "lamb", "comb".',
  },
  {
    id: 'pron-h-8',
    skill: 'pronunciation', tier: 'hard',
    prompt: 'Which word is pronounced "RES-luh"?',
    choices: ['wrestler', 'rustler', 'wriggler', 'rattler'],
    answer: 'wrestler',
    rule: 'In "wrestler", the W is silent and the T is barely heard — RES-luh.',
  },
  {
    id: 'pron-h-9',
    skill: 'pronunciation', tier: 'hard',
    prompt: 'Which word is pronounced "OAR-kuh-strah"?',
    choices: ['orchard', 'orchestra', 'octopus', 'oracle'],
    answer: 'orchestra',
    rule: 'OAR-kuh-strah = orchestra. The "ch" sounds like /k/ — this happens in Greek-origin words.',
  },
  {
    id: 'pron-h-10',
    skill: 'pronunciation', tier: 'hard',
    prompt: 'Which word is pronounced "kuh-MEET" (a hairy space rock)?',
    choices: ['comet', 'commit', 'commute', 'complete'],
    answer: 'comet',
    rule: 'kuh-MEET = comet — a space rock with a tail. Stress goes on the second syllable.',
  },

  // -- additional multiple-meanings — medium --
  {
    id: 'multi-m-9',
    skill: 'multiple-meanings', tier: 'medium',
    prompt: 'Which meaning of "watch" fits this sentence?',
    context: 'I got a new watch for my birthday.',
    choices: [
      'a small clock you wear on your wrist',
      'to look at carefully',
      'a turn guarding something',
      'a group of guards',
    ],
    answer: 'a small clock you wear on your wrist',
    rule: '"For my birthday" = a gift. A "watch" you GET is the wrist clock.',
  },
  {
    id: 'multi-m-10',
    skill: 'multiple-meanings', tier: 'medium',
    prompt: 'Which meaning of "watch" fits this sentence?',
    context: 'Please watch the soup so it doesn\'t burn.',
    choices: [
      'a small clock you wear on your wrist',
      'to look at carefully',
      'a turn guarding something',
    ...
    answer: 'to look at carefully',
    rule: 'Watching the soup means looking after it. "Watch" here is a verb.',
  },
  {
    id: 'multi-m-11',
    skill: 'multiple-meanings', tier: 'medium',
    prompt: 'Which meaning of "ring" fits this sentence?',
    context: 'I heard the doorbell ring twice.',
    choices: [
      'a circle of metal you wear on a finger',
      'a circular shape',
      'to make a bell-like sound',
      'a boxing arena',
    ],
    answer: 'to make a bell-like sound',
    rule: '"Doorbell" — the sound it makes when it rings. "Ring" here is a verb.',
  },
  {
    id: 'multi-m-12',
    skill: 'multiple-meanings', tier: 'medium',
    prompt: 'Which meaning of "ring" fits this sentence?',
    context: 'Mom\'s gold ring sparkled in the light.',
    choices: [
      'a circle of metal you wear on a finger',
      'a circular shape on the ground',
      'to make a bell-like sound',
      'a phone call',
    ],
    answer: 'a circle of metal you wear on a finger',
    rule: '"Gold" + "sparkled" — that\'s jewelry. The ring on a finger.',
  },

  // -- additional alpha-order — medium --
  {
    id: 'alpha-m-7',
    skill: 'alpha-order', tier: 'medium',
    prompt: 'Which word comes FIRST in alphabetical order?',
    choices: ['thumb', 'throw', 'thank', 'thick'],
    answer: 'thank',
    rule: 'All start with "th". 3rd letters: a, i, r, u. "thank" (a) is first.',
  },
  {
    id: 'alpha-m-8',
    skill: 'alpha-order', tier: 'medium',
    prompt: 'Which word comes LAST in alphabetical order?',
    choices: ['sponge', 'spider', 'spoon', 'space'],
    answer: 'spoon',
    rule: 'All start with "sp". 3rd letters: a, i, o, o → narrow to "sponge" and "spoon". 4th letters: n vs o. Since "n" comes before "o", SPONGE comes first and SPOON comes last.',
  },

  // -- additional guide-words — easy/medium --
  {
    id: 'guide-e-7',
    skill: 'guide-words', tier: 'easy',
    prompt: 'Page guide words: kite / lemon. Which word is on this page?',
    choices: ['kitten', 'jelly', 'monkey', 'apple'],
    answer: 'kitten',
    rule: '"kitten" (ki-t-t) comes after "kite" (ki-t-e) and before "lemon" (l-). On the page.',
  },
  {
    id: 'guide-m-6',
    skill: 'guide-words', tier: 'medium',
    prompt: 'Page guide words: cherry / chimney. Which word is on this page?',
    choices: ['chess', 'chase', 'chunk', 'champion'],
    answer: 'chess',
    rule: '"chess" (ch-e-s) comes after "cherry" (ch-e-r) because s > r at the 4th letter. And "chimney" (ch-i) comes after "chess" because i > e at the 3rd letter. So chess lands on the page.',
  },
];
